...
The STATA replication code can be found in my GitHub repo

^[All analysis for this paper is available in my GitHub: https://github.com/LizMas/1006_replication].
