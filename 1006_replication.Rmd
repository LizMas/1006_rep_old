---
title: "Replication of Findley et al. (2012)" 
author: "Liz Masten"
date: "4/29/2020"
...
model_comb <- matrix(c(mod_cluster_1,mod_cluster_2, mod_cluster_3, mod_cluster_4))

#ext_table <- stargazer(model_comb, 
 #                  type = "latex",
  #                 title = "Quasipoisson Clustered Models of Transnational Terrorist Activity per Findley et al (2012)")

table1 <- huxreg("Model 1" = mod_cluster_1,
...
#models <- list()
#models[['Model 1']] <- mod_cluster_1
#models[['Model 2']] <- mod_cluster_2
#models[['Model 3']] <- mod_cluster_3
#models[['Model 4']] <- mod_cluster_4

#msummary(models)

#model_comb <- matrix(c(mod_cluster_1,mod_cluster_2, mod_cluster_3, mod_cluster_4))

#print(xtable(model_comb, digits=3), type = 'latex')


``` 

```{r wald, results= 'asis', header = FALSE, echo=FALSE, message=FALSE, warning=FALSE}

#wald_table <- stargazer(mod_wald_1, mod_wald_2, mod_wald_3, mod_wald_4, type = "latex")

#wald_table

# lots of junk in the output. 
