...
#data from ITERATE for extension. Harvard Dataverse only had 1968-2002 as a continuous dataset, with yearly updates from 2003-2016. I had to download these years individually and combine here: 

i16 <- read.csv("iterate_2016.csv")
i15 <- read.csv("iterate_2015.csv")
i14 <- read.csv("iterate_2014.csv")
i13 <- read.csv("iterate_2013.csv")
i12 <- read.csv("iterate_2012.csv")
i11 <- read.csv("iterate_2011.csv")
i10 <- read.csv("iterate_2010.csv")
i9 <- read.csv("iterate_09.csv")
i8 <- read.csv("iterate_08.csv")
i7 <- read.csv("iterate_07.csv")
i6 <- read.csv("iterate_06.csv") 
i5 <- read.csv("iterate_05.csv")
i4 <- read.csv("iterate_04.csv")
i3 <- read.csv("iterate_03.csv")
i68_02 <- read.csv("iterate_1968_2002.csv")

#rbind 

iterate <- rbind(i68_02, i3, i4, i5, i6, i7, i8, i9, i10, i11, i12, i13, i14, i15, i16)
...
Findley, Piazza, and Young (2012) show that interstate rivalries are a positive predictor of transnational terrorist activity. The authors argue that terrorism is often a component of broader hostilities that can be emperically analyzed using a series of politicaly relevant directed dyads. While this paper is a successful replication of their work, I call into question their choice to use dyadic analysis. When using country-year analysis as opposed to directed dyad analysis, I find that ... my findings don't make sense. 
...
#this is my extension, without the SEs because I can't figure out how to do that on STATA yet... 
...
# 2) A beautiful graphic which uses this data: change it to be better - I actually don't plan on using this at all unless I have to. 
...
#attempt at country-year analysis
